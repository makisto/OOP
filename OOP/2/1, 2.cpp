...
public:
	...
	void output()
	{
		...
		if (tmp == NULL) cout << "Список пуст" << endl;
		else
		{
			while (tmp->next != NULL)
			{
...
int main()
{
	...
	{
		system("CLS");
		cout << "1. Формирование списка полных квадратов" << endl;
		cout << "2. Построение стека" << endl;
		cout << "3. Построение очереди" << endl;
		cout << "0. Выход" << endl;
		cin >> ch;
		system("CLS");
		switch (ch)
